    ...
    <v-card-text class="mt-2">
      <div v-if="page === 1">
        <v-row class="text-h5" justify="center">
          <v-col cols="12" md="12">Title: {{ item.title }} </v-col>
          <v-col cols="12" md="12"> Branch: {{ item.branch }} </v-col>
          <v-col cols="12" md="12"> Semester: {{ item.sem }} </v-col>
        </v-row>
        <v-row>
      ...
      <div v-if="page === 2">
        ...
        >
          <v-card-title
            >Room: {{ index + 1 }} {{ item.faculties[1] }}</v-card-title
          >
          <v-container>
            <v-row
              justify="center"
