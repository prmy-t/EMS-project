      ...
      <v-card>
        <v-container>
          <v-card-text class="text-center">
            ...
            <v-row>
              <v-col md="3" lg="3" sm="3" cols="12">
                <p class="text--secondary text-h6">Choose dates :</p>
              </v-col>
              <v-col v-if="this.$vuetify.breakpoint.xs" cols="12">
                <v-menu
                  ref="menu"
                  v-model="menu"
    ...
    <v-stepper-content step="4">
      <v-card height="auto" width="auto" class="justify-center">
        ...
        <v-row justify="space-between">
          <v-col align="start" cols="12" lg="6" md="6" sm="6">
            <v-btn color="indigo darken-2" @click="step = 3" text>
              <v-icon>navigate_before </v-icon>
              Previous
            </v-btn>
          </v-col>
          <v-col align="end" cols="12" lg="6" md="6" sm="6">
            <v-btn
              dark
              color="indigo darken-2"
              :disabled="!validPage2"
