<template>
  <v-card rounded="lg">
    ...
    <v-card-text class="mt-2">
      <div v-if="page === 1">
        <v-row class="text-h5" justify="start">
          <v-col cols="12" md="4" lg="4" sm="6">Title: {{ item.title }} </v-col
          ><v-col cols="12" md="4" lg="4" sm="6">
            Branch: {{ item.branch }}
          </v-col>
          <v-col cols="12" md="4" lg="4" sm="6">Semester: {{ item.sem }}</v-col>
        </v-row>
        <v-row>
          <v-col
            cols="12"
